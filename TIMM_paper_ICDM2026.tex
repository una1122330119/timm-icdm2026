...
An anonymous, open-source implementation of TIMM — including the TRR-set generator, all baseline algorithms, experiment scripts, and full configuration files with random seeds — is available at \url{https://anonymous.4open.science/r/timm-icdm2026}. All experiments in this paper are reproducible from this repository with a single command per dataset.
